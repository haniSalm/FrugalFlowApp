...
public class HousingCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton fab = findViewById(R.id.add_housing_expense);
    ...
    private void loadBudget() {
        userRef.child("budgets").child("Housing").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(HousingCategoryActivity.this,
                        R.string.budget_load_failed, Toast.LENGTH_SHORT).show();
            }
        });
    }

    private void loadHousingTransactions() {
        userRef.child("housing").child("Housing").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
