...
public class HealthCareCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton fab = findViewById(R.id.add_healthcare_expense);
    ...
    private void loadBudget() {
        userRef.child("healthcare").child("HealthCare").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(HealthCareCategoryActivity.this,
                        R.string.budget_load_failed, Toast.LENGTH_SHORT).show();
            }
        });
    }

    private void loadHealthCareTransactions() {
        userRef.child("healthcare").child("HealthCare").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
