...
public class EntertainmentCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton fab = findViewById(R.id.add_entertainment_expense);
    ...
    private void loadBudget() {
        userRef.child("budgets").child("Entertainment").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(EntertainmentCategoryActivity.this,
                        R.string.budget_load_failed, Toast.LENGTH_SHORT).show();
            }
        });
    }

    private void loadEntertainmentTransactions() {
        userRef.child("entertainment").child("Entertainment").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
