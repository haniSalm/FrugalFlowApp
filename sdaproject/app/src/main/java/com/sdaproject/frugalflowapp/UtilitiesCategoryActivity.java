...
public class UtilitiesCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton fab = findViewById(R.id.add_utilities_expense);
    ...
    private void loadBudget() {
        userRef.child("budgets").child("Utilities").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(UtilitiesCategoryActivity.this,
                        R.string.budget_load_failed, Toast.LENGTH_SHORT).show();
            }
        });
    }

    private void loadUtilitiesTransactions() {
        userRef.child("utilities").child("Utilities").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
