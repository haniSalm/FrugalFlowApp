...
public class FoodCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton fab = findViewById(R.id.add_food_expense);
    ...
    private void loadBudget() {
        userRef.child("budgets").child("Food").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    private void loadFoodTransactions() {
        userRef.child("transactions").child("Food").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
