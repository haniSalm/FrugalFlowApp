...
public class TransportationCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton fab = findViewById(R.id.add_transportation_expense);
        ...
        // Load data
        loadBudget();
        loadTransportationTransactions();
    ...
    private void loadBudget() {
        userRef.child("budgets").child("Transportation").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(TransportationCategoryActivity.this,
                        R.string.budget_load_failed, Toast.LENGTH_SHORT).show();
            }
        });
    }

    private void loadTransportationTransactions() {
        userRef.child("transactions").child("Transportation").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
